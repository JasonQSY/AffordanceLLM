...
class TrainData(data.Dataset):
    def __init__(self, exocentric_root, egocentric_root, resize_size=256, crop_size=224, divide="Seen"):
        ...
        if divide == "Seen":
            ...
            # split 1
            # self.aff_list = ['drink_with', 'catch', 'look_out', 'drag', 'text_on', 'sip', 'lie_on', 'lift', 'pick_up', 'jump', 'sit_on', 'cut_with', 'carry', 'swing', 'beat', 'stick', 'kick', 'pour', 'take_photo', 'write', 'throw', 'eat', 'boxing', 'cut', 'pack', 'hold', 'hit']
            
            # split 2
            # self.aff_list = ['carry', 'cut', 'wash', 'ride', 'hit', 'throw', 'sit_on', 'pour', 'stir', 'eat', 'drink_with', 'peel', 'cut_with', 'sip', 'boxing', 'pack', 'type_on', 'kick', 'jump', 'look_out', 'hold', 'take_photo', 'drag', 'lie_on', 'catch', 'beat', 'text_on']

            # split 3
            # self.aff_list = ['cut', 'text_on', 'look_out', 'brush_with', 'beat', 'catch', 'pour', 'pack', 'lift', 'sip', 'ride', 'hold', 'hit', 'wash', 'drink_with', 'stir', 'cut_with', 'kick', 'open', 'carry', 'peel', 'eat', 'take_photo', 'stick', 'jump', 'talk_on', 'lie_on']
            ...
            raise ValueError("divide unavailable")
        
        print("train has {} actions".format(len(self.aff_list)))
        print("train has {} objects".format(len(self.obj_list)))
        ...
        for file in files:
            ...
            for obj_file in obj_files:
                # filter object
                if obj_file not in self.obj_list:
                    continue
